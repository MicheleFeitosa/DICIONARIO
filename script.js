...
for (var bio in biografias){
    ...
    '</summary>' +
    '<p>' +
    biografias[bio].descrição +
    '</p>' + 
    '<blockquote><q>' +
    biografias[bio].citação +
    '</q></blockquote>' +
    '</details>' +
    '</div>';
